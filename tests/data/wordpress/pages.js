export const pages = [
  ...
  },
  {
    ...
    contentType: 'page',
    renderType: 'p',
    link: 'http://wp.com/home/sample-page/',
    title: 'Sample Page',
    content: [
      {
        contentType: 'core/paragraph',
      ...
      {
        contentType: 'core/blockquote',
        tag: 'p',
        content: 'Hi there! I&#8217;m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin&#8217; caught in the rain.)'
      },
      {
        contentType: 'frm/custom',
        renderType: 'custom',
        title: 'Title',
        text: 'Text',
      ...
      },
      {
        ...
        content: [
          {
            content: 'As a new WordPress user, you should go to '
          },
          {
            tag: 'a',
            attr: {
